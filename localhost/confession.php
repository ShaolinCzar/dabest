...
<body>
    ...
    <div class="registration">
        <div class="text_1">Признание авторских прав</div>
        <div class="text_2">Признание авторских прав в суде</div>
        <div class="text_3">Взыскание материальной ответственности за нарушение авторских прав</div>
        <div class="text_descr">
            - Признание авторских прав от 1 месяца<br>
            - Защита авторских прав в суде от 60 000 руб<br>
    ...
    <div class="owl-carousel owl-theme">
        <div class="slider1">КАК ПРОИСХОДИТ ПРИЗНАНИЕ АВТОРСКИХ ПРАВ?</div>
        <div class="slider2">
            <div class="title">Анализ информации по объекту авторских прав</div>
            <div class="slider_descr">- Сбор и анализ документов, необходимых для защиты авторских прав</div>
            <div class="uget">Вы получаете консультацию эксперта по защите авторских прав</div>
            <div class="deadline">сроки: от 1 дня</div>
        </div>
        <div class="slider3">
            <div class="title">Подготовка документации и искового заявления</div>
            <div class="slider_descr">- Сбор и составление документов, подготовка искового заявления в суд</div>
            <div class="uget">Вы получаете консультацию эксперта по стратегии защиты в суде</div>
            <div class="deadline">сроки: 15 дней</div>
        </div>
        <div class="slider4">
            <div class="title">Защита интересов в суде и признание авторских прав</div>
            <div class="slider_descr">- Защита интересов Клиента в суде <br>- Признание авторских прав</div>
            <div class="uget">Вы получаете признание авторских прав на произведение</div>
    ...
    <div class="prices">
        ...
        <div class="price1">
            <div class="price1header"><?$p1h = "Установление правообладателя в суде"; echo $p1h; global $p1h;?></div>
            <div class="price1description1">- Сбор и анализ документов, необходимых для защиты авторских прав
            </div>
            <div class="price1description2">- Сбор и составление документов, подготовка искового заявления в суд</div>
            <div class="price1description3">- Защита интересов в суде и признание авторских прав</div>
            <div class="price1price">От <?$firstPrice = 60000; echo $firstPrice; global $firstPrice;?> руб</div>
        ...
        <div class="price2">
            <div class="price1header"><?$p2h = "Второй вариант"; echo $p2h;?> <br></div>
        ...
        <div class="price3">
            <div class="price1header"><?$p3h = "Третий вариант"; echo $p3h;?> <br></div>
            <div class="price1description1">- Ускоренный сбор и составление документов, необходимых 
                для регистрации произведения
            </div>
            <div class="price1description2">- Заключение договора с РАО от имени автора</div>
    ...
    <div class="services">
        ...
        <span><i class="fas fa-globe fa-2x" aria-hidden="true"></i></span>
            <div class="service_header">Международная регстрация авторских прав</div>
        ...
        <button class="service4" onclick="window.location='index.php'">
