...
<body>
    ...
    <div class="registration">
        <div class="text_1">Депонирование</div>
        <div class="text_2">Официальное закрепление авторских прав на неопубликованное произведение</div>
        <div class="text_3">Передача произведения на ответственное хранение в РАО</div>
        <div class="text_descr">
            - Депонирование от 1 дня<br>
            - Стоимость от 3000 рублей<br>
    ...
    <div class="owl-carousel owl-theme">
        <div class="slider1">КАК ПРОИСХОДИТ ДЕПОНИРОВАНИЕ АВТОРСКИХ ПРАВ?</div>
        <div class="slider2">
            <div class="title">Получение информации по объекту депонирования</div>
            <div class="slider_descr">- Направление информации по объекту депонирования<br>- Консультация специалиста</div>
            <div class="uget">Вы получаете консультацию эксперта по защите авторских прав</div>
            <div class="deadline">сроки: от 1 дня</div>
        </div>
        <div class="slider3">
            <div class="title">Подготовка документов для депонирования произведения</div>
            <div class="slider_descr">- Сбор и составление документов, необходимых для депонирования произведения<br>
            - Внесение сведений в реестр РАО</div>
            <div class="uget">Вы получаете консультацию эксперта по защите авторских прав</div>
            <div class="deadline">сроки: от 1 дня</div>
        </div>
        <div class="slider4">
            <div class="title">Получение свидетельства о депонировании произведения</div>
            <div class="slider_descr">- Получение Свидетельства о депонировании произведения</div>
            <div class="uget">Вы получаете Свидетельство о депонировании произведения</div>
            <div class="deadline">сроки: от 1 дня</div>
        </div>
    </div>
    ...
    <div class="prices">
        ...
        <div class="price1">
            <div class="price1header"><?$p1h = "Депонирование авторских прав"; echo $p1h; global $p1h;?></div>
            <div class="price1description1">- Сбор и составление документов, необходимых для депонирования произведения
            </div>
            <div class="price1description2">- Внесение сведений в реестр РАО</div>
            <div class="price1description3">- Получение Свидетельства о депонировании произведения</div>
            <div class="price1price">От <?$firstPrice = 3000; echo $firstPrice; global $firstPrice;?> руб</div>
        ...
        <div class="price2">
            <div class="price1header"><?$p2h = "Второй вариант"; echo $p2h;?></div>
        ...
        <div class="price3">
            <div class="price1header"><?$p3h = "Третий вариант"; echo $p3h;?></div>
            <div class="price1description1">- Ускоренный сбор и составление документов, необходимых 
                для регистрации произведения
            </div>
            <div class="price1description2">- Заключение договора с РАО от имени автора</div>
    ...
    <div class="services">
        ...
        <button class="service5" onclick="window.location='index.php'">
